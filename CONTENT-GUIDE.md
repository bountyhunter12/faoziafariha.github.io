...
<article class="pub" id="pub-shortname-2027">
  ...
  <p class="pub__authors">First Author, <span class="me">Faozia Fariha</span>, Last Author</p>
  ...
  author  = {Surname, Given Names and Fariha, Faozia},
...
Overwrite `assets/cv/Faozia_Fariha_CV.pdf`, keeping the same filename.
...
| Google Scholar | `https://scholar.google.com/citations?hl=en&user=2KRgeSgAAAAJ` |
| GitHub | `https://github.com/bountyhunter12` |
| LinkedIn | `https://www.linkedin.com/in/faozia-fariha` |
| Site URL | `https://bountyhunter12.github.io/` |

There is no ORCID on file. If one is registered later, add it as a fifth
contact-row link on `index.html` (mirroring the Scholar/GitHub/LinkedIn
pattern) and to the `sameAs` array in the homepage's JSON-LD.
